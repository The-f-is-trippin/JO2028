...
INSERT INTO LIEU (id_lieu, nom_lieu, adresse_lieu, cp_lieu, ville_lieu) VALUES
    (1, 'Stade de Los Angeles', '123 Los Angeles Blvd', '90001', 'Los Angeles'),
    (2, 'Gymnase de Los Angeles', '456 Gym St', '90002', 'Los Angeles'),
    (3, 'Staples Center', '1111 S Figueroa St', '90015', 'Los Angeles');
...
INSERT INTO EPREUVE (id_epreuve, nom_epreuve, date_epreuve, heure_epreuve, id_lieu, id_sport) VALUES
    (1, '100m', '2028-07-20', '14:30', 1, 1),
    (2, 'Saut en hauteur', '2028-07-21', '10:00', 2, 2),
    (3, 'Natation', '2028-07-22', '15:45', 1, 3),
    (4, 'Course cycliste', '2028-07-23', '09:15', 2, 4),
    (5, 'Lancer de poids', '2028-07-24', '14:45', 1, 5),
    (6, 'Saut en longueur', '2028-07-25', '11:30', 2, 6),
    (7, 'Gymnastique artistique', '2028-07-26', '16:15', 1, 7),
    (8, 'VTT', '2028-07-27', '10:30', 2, 8),
    (9, 'Boxe', '2028-07-28', '15:00', 3, 9),
    (10, 'Escalade', '2028-07-29', '09:45', 1, 10);
...
INSERT INTO UTILISATEUR (id_utilisateur, nom_utilisateur, prenom_utilisateur, login, password) VALUES
    ...
    (3, 'User', 'Jane', 'jane_doe', '$2y$10$xP/2LE33Hy./Je/CLqLyL.8KJFWgXsHXcaln/usfr8Vv6INtCKIoO');-- Suppression des données existantes dans les tables
DELETE FROM PARTICIPER;
DELETE FROM EPREUVE;
DELETE FROM ATHLETE;
DELETE FROM PAYS;
