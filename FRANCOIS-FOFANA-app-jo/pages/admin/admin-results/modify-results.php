...
<body>
    ...
    <main>
        ...
        <form action="modify-results.php?id_athlete=<?= $id_athlete ?>&id_epreuve=<?= $id_epreuve ?>" method="post" onsubmit="return confirm('Êtes-vous sûr de vouloir modifier ce résultat ?')">
