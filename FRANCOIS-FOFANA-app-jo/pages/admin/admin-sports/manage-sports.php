...
<body>
    ...
    <main>
        ...
        <div class="action-buttons">
            <button class="btn btn-outline-success" onclick="openAddSportForm()">Ajouter un Sport</button>
        </div>
        ...
        try {
            ...
            if ($statement->rowCount() > 0) {
                ...
                while ($row = $statement->fetch(PDO::FETCH_ASSOC)) {
                    ...
                    echo "<td><button class='btn btn-outline-primary'onclick='openModifySportForm({$row['id_sport']})'>Modifier</button></td>";
                    echo "<td><button class='btn btn-outline-danger' onclick='deleteSportConfirmation({$row['id_sport']})'>Supprimer</button></td>";
                    echo "</tr>";
                }
