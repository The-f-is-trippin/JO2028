    ...
    <header>
        <nav>
            ...
            <li><a href="../admin/admin.php">Accueil Administration</a></li>
                ...
                <li><a href="../admin/admin-events/manage-events.php">Gestion Calendrier</a></li>
                <li><a href="../admin/admin-athletes/manage-athletes.php">Gestion Athlètes</a></li>
                <li><a href="../admin/admin-gender/manage-gender.php">Gestion Genres</a></li>
                <li><a href="../admin/admin-results/manage-results.php">Gestion Résultats</a></li>
